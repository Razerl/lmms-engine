...
PROCESSOR_NAME="/data/rzli/data/data_ssd_smb/models/QwenVL/Qwen2.5-VL-3B-Instruct"
MODEL_PATH="/data/rzli/data/data_ssd_smb/models/QwenVL/Qwen2.5-VL-3B-Instruct"
...
NUM_TRAIN_EPOCHS=1
RUN_NAME="Qwen2_5VL-3B-OMS-ONLY-SFT-0104"
